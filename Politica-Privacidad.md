...
El usuario no necesita introducir ningún dato de carácter personal para poder acceder todas a las características de la aplicación.
...
Puesto que no se necesita ningún dato por parte del usuario, no son almacenados en la aplicación.

## 5. DESTINATARIOS

Puesto que no se necesita ningún dato por parte del usuario, los datos no son compartidos con terceras partes.
...
Miguel Romeral, informa al Usuario de que le asisten los derechos de acceso, rectificación, limitación, supresión, oposición y portabilidad, los cuales podrá ejercitar mediante petición dirigida al correo electrónico: [miguel.romeral@hotmail.com](mailto:miguel.romeral@hotmail.com)
